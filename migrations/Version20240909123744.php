...
final class Version20240909123744 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE build (id INT AUTO_INCREMENT NOT NULL, creator_id INT NOT NULL, champion_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, visibility TINYINT(1) NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, UNIQUE INDEX UNIQ_BDA0F2DB61220EA6 (creator_id), INDEX IDX_BDA0F2DBFA7FD7EB (champion_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
